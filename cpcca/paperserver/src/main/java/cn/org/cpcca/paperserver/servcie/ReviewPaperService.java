...
public interface ReviewPaperService{
	...
	public List searchPapersByRevid(Integer revid);//通过评审项目查询

	public List<ReviewPaperModel> searchPapersByDirection(Map<String,Object> queryParam);//通过项目id查询
	...
	List<ReviewProgressModel> reviewProgress(int revid); //进度数据
